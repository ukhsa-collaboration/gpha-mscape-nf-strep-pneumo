...
| context       | Boolean specifying whether to include the context in the analysis records. False by default, if True, must have "orange_box_version" column in the samplesheet. |
